      ...
      <div className="col-12 col-md">
        <div className="container container-fluid">
          <Fragment>
            ...
            <div className="form-group">
              <label htmlFor="barcode_field">Barcode (Optional)</label>
              <input
                type="text"
                id="barcode_field"
                className="form-control"
              ...
              />
              <small className="form-text text-muted">Leave empty to auto-generate later</small>
            </div>
            ...
            <div className='form-group'>
              ...
              {imagesPreview.length > 0 && <span className="mr-2">{imagesPreview.length} file(s) selected</span>}
