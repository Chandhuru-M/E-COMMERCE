...
const ticketSchema = new mongoose.Schema({
  ...
  type: { 
    type: String, 
    enum: ['USER_QUERY', 'MERCHANT_QUERY', 'ORDER_ISSUE', 'PAYMENT_ISSUE', 'PRODUCT_COMPLAINT', 'RETURN_REFUND', 'TECHNICAL', 'BILLING', 'ACCOUNT', 'MERCHANT_STORE_ISSUE', 'MERCHANT_PAYMENT_ISSUE', 'MERCHANT_INVENTORY_ISSUE', 'MERCHANT_SETTLEMENT_ISSUE', 'MERCHANT_TECHNICAL_ISSUE'],
    required: true 
  },
